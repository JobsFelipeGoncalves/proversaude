...
<head>
  ...
  <title>Sistema Prover Saúde - Conheça nossas vantagens e benefícios.</title>
  <meta charset="UTF-8">
...
<body class = "f-d">
  ...
  <!-- apresentacao -->
  <section id = "apresentacao" class = "f-d pt-3 pb-5">
    <div class="container pt-3 pb-5">
      <div class="row p-5">
        ...
        <div class="col-12 col-sm-12 col-lg-6 centro  wow animate__animated animate__fadeIn" data-wow-delay="0.5s">
          <img src="<?= BASE_IMG ?>fundos/familiar_prover.png" class = "img-fluid ">
        </div>
      </div>
    </div>
  </section>
  ...
  <section id = "v-e-b" class = "v-e-b f-branco pt-5 pb-5">
    <div class="container pt-5 pb-5">
      <div class="row p-5">
        <div class="col-12 col-sm-12 col-lg-4 mb-5  wow animate__animated animate__fadeIn" data-wow-delay="0.5s">
          <h1 class = "display-5 negrito c-a mb-3">
            ...
            <h5 class = "cinza-9 mb-3">
              ...
              vantagens e benefícios que
              só o Sistema Prover Saúde 
              oferece.
            </h5>
        </div>
        ...
        <div class="col-12 col-sm-12 col-lg-7  wow animate__animated animate__fadeIn" data-wow-delay="1s">
          <div class="row cinza-7 f-p-5">
            <div class="col-12 col-sm-6 col-lg-4 mb-3 ">
              <img src="<?= BASE_IMG ?>extra/icone_consulta.png" class = "v-e-b-icones"><br>
              <p class = "p-2">
                Consultas 
                em todas as 
                especialidades 
            ...
            <div class="col-12 col-sm-6 col-lg-4 mb-3 ">
              <img src="<?= BASE_IMG ?>extra/icone_telemedicina.png" class = "v-e-b-icones"><br>
              <p class = "p-2">
                Consultas
                de urgência 24 
                horas via Dr. Prover
            ...
            <div class="col-12 col-sm-6 col-lg-4 mb-3 ">
              <img src="<?= BASE_IMG ?>extra/icone_exames.png" class = "v-e-b-icones"><br>
              <p class = "p-2">
                Exames clínicos, 
                laboratoriais e
                diagnósticos por
            ...
            <div class="col-12 col-sm-6 col-lg-4 mb-3">
              <img src="<?= BASE_IMG ?>extra/icone_auxilio.png" class = "v-e-b-icones"><br>
              <p class = "p-2">
                Benefícios 
                assistênciais
                seguro e auxilio
            ...
            <div class="col-12 col-sm-6 col-lg-4 mb-3 ">
              <img src="<?= BASE_IMG ?>extra/icone_clube.png" class = "v-e-b-icones"><br>
              <p class = "p-2">
                Clube de 
                vantagens
                e descontos 
          ...
          <div class="row mb-2 mt-2">
            <div class="col">
              <a href="<?= BASE ?>vantagens-e-beneficios" class = "botao botao-b">
                Ver mais benefícios
                <span class="material-symbols-rounded f-12">
                arrow_forward
                </span>
              </a>
            </div>
  ...
  <section id = "planos-pf-home" class = " planos-pf-home f-cinza-1 pt-5 pb-5">
    <div class="container pt-5 pb-5">
      ...
      <div class="row p-5">
        <div class="col-12 col-sm-12 col-lg-5 p-5 wow animate__animated animate__fadeIn" data-wow-delay="0.5s">
           <div class="row mb-5">
             <div class="col-12 col-sm-12 col-lg-12">
                <img src="<?= BASE_IMG ?>marcas/mod_quality.png" class = "img-fluid mb-3 planos-pf-home-img"><br>
                <h5 class = "cinza-9 mb-3">
                  Consultas em todas as especialidades
                  médicas por apenas <b>R$ 60,00</b>
                </h5>
                <p class = "mb-3">
                  <a href="<?= BASE ?>planos/quality" class = "botao botao-c">Saiba mais</a>
                </p>
             </div>
           </div>
           ...
           <div class="row mb-5">
             <div class="col-12 col-sm-12 col-lg-12">
                <img src="<?= BASE_IMG ?>marcas/mod_classico.png" class = "img-fluid mb-3 planos-pf-home-img"><br>
                <h5 class = "cinza-9 mb-3">
                  Adicione agregados em 
                  seu Sistema Prover Saúde
                </h5>
                <p class = "mb-3">
                  <a href="<?= BASE ?>planos/classico" class = "botao botao-c">Saiba mais</a>
                </p>
             </div>
           </div>
        </div>
        ...
        <div class="col-12 col-sm-12 col-lg-6 p-4 centro wow animate__animated animate__fadeIn" data-wow-delay="0.5s">
          <img src="<?= BASE_IMG ?>fundos/familia_pessoa_fisica.png" class = "img-fluid ">
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container pt-5 pb-5">
      ...
      <div class="row p-5">
        <div class="col-12 col-sm-12 col-lg-5 p-5 wow animate__animated animate__fadeIn" data-wow-delay="0.5s">
           <div class="row mb-5">
             <div class="col-12 col-sm-12 col-lg-12">
                <img src="<?= BASE_IMG ?>marcas/mod_corporate_master.png" class = "img-fluid mb-3 planos-pf-home-img"><br>
                <h5 class = "cinza-9 mb-3">
                  Consultas em todas as especialidades
                  médicas por apenas  <b>R$ 35,00</b>
                </h5>
                <p class = "mb-3">
                  <a href="<?= BASE ?>planos/corporate-master" class = "botao botao-c">Saiba mais</a>
                </p>
             </div>
           </div>
           ...
           <div class="row mb-5">
             <div class="col-12 col-sm-12 col-lg-12">
                <img src="<?= BASE_IMG ?>marcas/mod_quality_corporate.png" class = "img-fluid mb-3 planos-pf-home-img"><br>
                <h5 class = "cinza-9 mb-3">
                  Consultas em todas as especialidades
                  médicas por apenas  <b>R$ 60,00</b>
                </h5>
                <p class = "mb-3">
                  <a href="<?= BASE ?>planos/quality-corporate" class = "botao botao-c">Saiba mais</a>
                </p>
             </div>
           </div>
        </div>
        ...
        <div class="col-12 col-sm-12 col-lg-6 p-4 centro wow animate__animated animate__fadeIn" data-wow-delay="1s">
          <img src="<?= BASE_IMG ?>fundos/familia_pessoa_juridica.png" class = "img-fluid ">
        </div>
      </div>
    </div>
  </section>
  ...
  <!-- depoimentos -->
  <section id = "depoimentos-home" class = "depoimentos-home f-a pt-5 pb-5">
